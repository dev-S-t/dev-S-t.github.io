# Sahil Tomar (dev-S-t) — Technical Profile
...
- **Multi-Tenant RAG (AnyAssist):** Google ADK agents, LiteLLM cost/routing gateway, and vector namespace isolation.
- **Privacy-First On-Prem RAG:** Inverted RAG topology over Agent-to-Agent (A2A) protocol for compliance-sensitive clients.
